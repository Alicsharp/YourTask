...
using Todo.Api.ViewModels.Auth;
...
namespace Todo.Api.Controllers
{
    public class AuthController : ApiController
    {
        ...
        private async Task<OperationResult<LoginResultDto?>> AddTokenAndGenerateJwt(UserDto user)
        {
            ...
            var tokenResult = await _userFacade.AddToken(new AddUserTokenCommand(user.Id, hashJwt, hashRefreshToken, DateTime.Now.AddDays(7), DateTime.Now.AddDays(8), ""));
